...
The parameters of the system are given values in \autoref{tab:parameters_system} and will be used for every simulation of the triple pendulum. The moments of inertia for each link is given by:
