...
%%%%%%%%%%%%% INITIAL CONDITIONS %%%%%%%%%%%%%%%%
x0 = zhistory1(end,:) + [0 0 0 0 0 0 0 0];
x0(2) = -x0(2);
x0(4) = -x0(4);
x0(6) = -x0(6);
x0(8) = -x0(8);
...
for i =1:N
    clc;
    fprintf('%d / %d',i,N);
    [t1,z1] = ode45(@three_dof_arm_cart_dyn_for_ODE, [0 dt 0.05], xprec,options,u,l1,l2,l3,m1,m2,m3,M,g);
