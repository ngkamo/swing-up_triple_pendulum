% Computing the second order variables
syms M m1 m2 m3;
...
Sol.xdd
eqx1sol = simplify(Sol.xdd)
eqx2sol = simplify(Sol.theta1dd);
eqx3sol = simplify(Sol.theta2dd);
eqx4sol = simplify(Sol.theta3dd);

syms y1 y2 y3 y4 y5 y6 y7 y8;
fx1 = subs(eqx1sol, {x,xd,theta1,theta1d,theta2,theta2d,theta3,theta3d}, {y1,y2,y3,y4,y5,y6,y7,y8});
fx2 = subs(eqx2sol, {x,xd,theta1,theta1d,theta2,theta2d,theta3,theta3d}, {y1,y2,y3,y4,y5,y6,y7,y8});
fx3 = subs(eqx3sol, {x,xd,theta1,theta1d,theta2,theta2d,theta3,theta3d}, {y1,y2,y3,y4,y5,y6,y7,y8});
fx4 = subs(eqx4sol, {x,xd,theta1,theta1d,theta2,theta2d,theta3,theta3d}, {y1,y2,y3,y4,y5,y6,y7,y8});
